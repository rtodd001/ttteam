...
const EPSILON = 0.01; // The web implementation in react-native-screens seems buggy.
...
class WebScreen extends React.Component {
  render() {
    ...
    return /*#__PURE__*/React.createElement(View // @ts-ignore
    , _extends({
      hidden: !active,
      style: [style, {
...
const MaybeScreenContainer = (_ref) => {
  ...
  if (enabled && Platform.OS !== 'web' && screensEnabled()) {
    return /*#__PURE__*/React.createElement(ScreenContainer, rest);
  }
